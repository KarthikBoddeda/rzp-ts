...
export function initMcpServer(params: {
  ...
  const client = new Rzp(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client = params.client || new Rzp({ defaultHeaders: { 'X-Stainless-MCP': 'true' } });
